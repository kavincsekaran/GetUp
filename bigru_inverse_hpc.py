...
config["result_filename"] = "Inverse_Transition_classification_results_BiGRU_{}_layers_{}_lr_{}_units_{}_epochs".format(config["num_layers"], config["learning_rate"], config["hidden_size"], config["num_epochs"])
